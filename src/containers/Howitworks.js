    ...
    return (
			...
			<AppBar position="static" color="default">
				...
				<ParallaxProvider>
					...
					<Parallax data={{'data-start': 'opacity: 1; background-size: cover; height:100vh; width: auto;','data-1000': 'opacity: 0;'}}>
					<Background> <img src={mountains_bkg1}/>

						<Parallax data={{'data-10': 'opacity: 1; position:fixed; top:40vh;','data-500': 'opacity: 0; top:-50vh;'}}>
						...
						<Parallax data={{'data-35': 'opacity: 0;', 'data-50': 'opacity: 1; position:fixed; left:50%; top:50vh;','data-500': 'opacity: 0; top:-50vh;'}}>
					...
					<Parallax data={{'data-1000': 'opacity: 1; background-size: cover; height:100vh; width: auto;','data-1500': 'opacity: 0;'}}>
					<Background> <img src={city_bkg2}/>

						<Parallax data={{'data-700': 'opacity: 0;', 'data-800': 'opacity: 1; position:fixed; top:40vh; left:30%;','data-1500': 'opacity: 0; top:-50vh;'}}>
							<div className='donna'></div>
						</Parallax>

						<Parallax data={{'data-500': 'opacity: 0;','data-800': 'opacity: 1; position:fixed; left:10%; top:40vh;','data-1500': 'opacity: 0; top:-50vh;'}}>
							<h2>Meet Donna</h2>
						</Parallax> 

						<Parallax data={{'data-800': 'opacity: 0;', 'data-900': 'opacity: 1; position:fixed; left:10%; top:45vh; width: 20%;','data-1500': 'opacity: 0; top:-50vh;'}}>
						...
						<Parallax data={{'data-800': 'opacity: 1; position: fixed; right:-10%; top:50vh;', 'data-1000': 'opacity: 1; right:50%; top:40vh;','data-1500': 'opacity: 0; top:-50vh;'}}>
					...
					<Background>
						...
						<Parallax data={{'data-1500': 'opacity: 0;', 'data-1600': 'opacity: 1; position:fixed; top:40vh; left:40%;','data-1800': 'opacity: 0; top:-50vh;'}}>
						...
						<Parallax data={{'data-1600': 'opacity: 0;','data-1700': 'opacity: 1; position:fixed; left:40%; top:50vh; width:20%;','data-1900': 'opacity: 0; top:-50vh;'}}>
							<div><h2>A blockchain-based platform where anyone can help a small charity directly by paying for its purchase.</h2></div> 
						</Parallax> 
						...
						<Parallax data={{'data-1650': 'opacity: 0; top:80vh;','data-1750': 'opacity: 1; position:fixed; left:40%; top:55vh; width:20%;','data-1950': 'opacity: 0; top:-50vh;'}}>
							<div><h2>On the platform, a pool of local merchants bid to cut the price of the purchase and eventually the lower bid receives the order</h2></div>
						</Parallax> 

						<Parallax data={{'data-1800': 'opacity: 0;', 'data-1900': 'opacity: 1; position:fixed; left:32%; top:60vh;','data-2100': 'opacity: 0; top:-50vh;'}}>
							<div><h1>What does this mean for Carolyn and Donna?</h1></div>
						</Parallax>
					...
					<Parallax>
					<Background>
						<Parallax data={{'data-2100': 'opacity: 0;','data-2200': 'opacity: 1; position:fixed; left:40%; top:60vh;', 'data-2600': 'opacity: 1; position:fixed; left:40%; top:60vh;','data-3500': 'opacity: 0.5; top:-50vh;'}}>
							<div className='triangle'></div>
						</Parallax> 

						<Parallax data={{'data-2200': 'opacity:0;', 'data-2300': 'opacity: 1; position:fixed; top:40vh;', 'data-2600': 'opacity: 1; position:fixed; top:40vh;','data-3500': 'opacity: 0.5; top:-50vh;'}}>
							<div className='carolyn'></div>
						</Parallax>

						<Parallax data={{'data-2200': 'opacity:0;', 'data-2300': 'opacity: 1; position:fixed; top:70vh; left:20%; width:10%;', 'data-2600': 'opacity: 1; position:fixed; top:70vh; left:20%; width:10%;','data-3500': 'opacity: 0.5; top:-50vh;'}}>
					...
					<Parallax>
					<Background>
						<Parallax data={{'data-3500': 'opacity: 0;','data-3600': 'opacity: 1; position:fixed; left:40%; top:30vh;', 'data-4000': 'opacity: 1; position:fixed; left:40%; top:30vh;','data-4100': 'opacity: 0.5; top:-50vh;'}}>
							<div className='kids'></div>
						</Parallax> 

						<Parallax data={{'data-3600': 'opacity:0;', 'data-3700': 'opacity: 1; position:fixed; left:40%; top:20vh;', 'data-4000': 'opacity: 1; position:fixed; left:40%; top:28vh;','data-4100': 'opacity: 0.5; top:-50vh;'}}>
							<div className='caps'></div>
						</Parallax>

						<Parallax data={{'data-3600': 'opacity:0;', 'data-3700': 'opacity: 1; position:fixed; left:45%; top:80vh;', 'data-4000': 'opacity: 1; position:fixed; left:45%; top:40vh;','data-4100': 'opacity: 0.5; top:-50vh;'}}>
