    ...
    return (
			...
			<ParallaxB       
				...
				<React.Fragment>
					...
					<Parallax data={{'data-top': 'opacity: 1; position:fixed; left:45%;','data-top-center': 'opacity: 0;'}}>
						<div>Scroll to see the story</div>
					</Parallax>


					<Parallax data={{'data-top': 'opacity: 1; position:absolute; left:30%; top:80vh;','data-top-bottom': 'opacity: 0; transform:translateY(-50vh);'}}>
					...
					<Parallax data={{'data-bottom-top': 'opacity: 0; top:200vh;', 'data-center-top': 'opacity: 1; position:absolute; left:10%; top:60vh; width:20%;','data-top-bottom': 'opacity: 0; transform:translateY(-10vh);'}}>
					...
					<Parallax data={{'data-bottom-top': 'opacity: 0; width: 25%; top:-100vh', 'data-center-center': 'opacity: 1; position:absolute; left:50%; top:40vh;','data-top-bottom': 'opacity: 0; transform:translateY(-10vh);'}}>               
						<div><h3> Every day, her pupils are in need of nutritious and safe food, clean water, clothing, textbooks, and toys</h3></div>
					</Parallax>			

				{/*Scene-2*/}	

					<Parallax data={{'data-500': 'opacity: 0;', 'data-600': 'opacity: 1; position:fixed; top:50vh; left:30%;', 'data-850': 'opacity: 1; position:fixed; top:50vh; left:30%;','data-1500': 'opacity: 0; top:-50vh;'}}>
				...
				{/*	Scene-4	*/}
					...
					<Parallax data={{'data-2000': 'opacity:0;', 'data-2200': 'opacity: 1; position:fixed; top:40vh; left:30%;', 'data-2600': 'opacity: 1; position:fixed; top:40vh;','data-3500': 'opacity: 0.5; top:-50vh;'}}>
						<div className='carolyn'></div>
					</Parallax>
