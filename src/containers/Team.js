			...
			<NavBar title="Team"/>
				<div className={classes.container}>
					...
					<div className={classes.intro}>
						...
						our  second adviser <a href="https://www.ischool.berkeley.edu/people/doug-tygar"  style={{textDecoration: 'none', color: '#343535'}}> Doug Tygar</a>. 
						...
						Bonney Ruan, thank you for helping to code this out and for the amazing characters that you created for our "How it works" animation.
